                    ...
                    <form onSubmit={registerUser}>
                        ...
                        <div className="field">
                            <div className="control">
                                <input className={classNames("input is-medium is-rounded", styles.input)} type="username" placeholder="Username" id="username" value={username} autoComplete="username" required 
